...
// Function to prompt the user for the executable path
std::string GetExecutablePathFromUser() {
    std::string path;
    std::cout << "Enter the full path of the executable you want to execute: ";
    std::getline(std::cin, path);
    return path;
}

int main() {
    std::string executablePath = GetExecutablePathFromUser();
